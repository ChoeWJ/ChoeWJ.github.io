...
```scss
/* system typefaces */
$serif: "Jua", "Iansui", "Pacifico", Georgia, Times, serif;
$sans-serif: "Jua", "Iansui", "Pacifico", -apple-system, BlinkMacSystemFont, "Roboto",
  "Segoe UI", "Helvetica Neue", "Lucida Grande", Arial, sans-serif;
$monospace: "Jua", "Iansui", "Pacifico", Monaco, Consolas, "Lucida Console",
  monospace;
```
...
```scss
$serif: "Jua", "Iansui", "Pacifico", "PT Serif", Georgia, Times, serif;
$sans-serif-narrow: "Jua", "Iansui", "Pacifico", "PT Sans Narrow", -apple-system,
  BlinkMacSystemFont, "Roboto", "Segoe UI", "Helvetica Neue", "Lucida Grande", Arial,
  sans-serif;
